...
class Pong {
    ...
    // сбрасывает позицию после проигрыша и обнуляет скорость
    reset() {
    ...
    // начало игры при условии, что скорость шара равна нулю по двум осям
    start() {
    ...
    update(dt) {
        ...
        // позиция левого игрока зависит от У позиции мяча
        // надо переосмыслить логику 
